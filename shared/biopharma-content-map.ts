...
export const BIOPHARMA_CONTENT_MAP: BiopharmaCoverageArea[] = [
  {
    ...
    nextAsset: "Qualified cross-functional review and a real permissioned product-process control-strategy case with accountable outcomes.",
  },
  {
  ...
  },
  {
    ...
    decisionPackageIds: ["biopharma-downstream-analytics-formulation"],
    materialGaps: ["Qualified product-quality, analytical, bioassay/statistics, reference-standard, QC, quality, validation, and regulatory review is not recorded.", "No real permissioned analytical-strategy, specification, reference-transition, method-transfer, or comparability case is available.", "No permissioned product-specific charge-variant, residual-DNA or reference-transition evidence is available."],
  ...
  },
  {
    ...
    decisionPackageIds: ["biopharma-validation-comparability-transfer"],
    materialGaps: ["The integrated technology-transfer and ICH Q5E content has no qualified cross-functional review.", "No real permissioned biologics transfer or comparability case connects execution, corrections, acceptance, continued verification, and actual outcomes."],
    ...
    nextAsset: "Qualified review and a real permissioned site-transfer or comparability case with pre-change/post-change traceability and accountable outcomes.",
  },
  {
