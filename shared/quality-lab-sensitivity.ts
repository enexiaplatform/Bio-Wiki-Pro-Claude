...
const definitions: DriverDefinition[] = [
  ...
  { id: "growthRatePercent", label: "Growth over planning horizon", unit: "% over horizon", mode: "add", variation: 10, min: -50, max: 500, plannerStep: 3, active: () => true, confidence: "medium", unresolvedIds: [], unresolvedCategories: ["portfolio", "workload"], evidenceNeeded: "Approved total growth forecast for the selected planning horizon, including product launches, transfers and scenario ownership. This input is not an annual CAGR.", decisionUse: "Determines the total current-to-horizon change in future staffing, area, equipment and budget; the percentage is applied once across the selected horizon.", relatedRuleIds: ["core.scenario.growth"] },
