...
export const DECISION_PACKAGES: DecisionPackage[] = ([
  ...
  },
  {
    ...
    limitations: sharedLimitations,
    reviewerRoles: ["quality control", "quality assurance", "manufacturing science", "data integrity or system ownership", "regulatory CMC"],
    reviewStatus: "editorial-reviewed",
    riskLevel: "high",
    compilerMode: "evidence-context-only",
    ...
    assetRefs: [
      ...
      asset("toolkit", "investigation-capa-change-evidence-loop", "Investigation, CAPA and change evidence loop"),
