...
export const MANUFACTURING_QUALITY_PORTFOLIO: ManufacturingQualityPortfolioLane[] = [
  ...
  },
  {
    ...
    areas: [
      {
        id: "analytical-development-and-lifecycle", title: "Analytical development and lifecycle", decision: "Define the analytical question, performance evidence, transfer and lifecycle controls before results support a decision.", functions: ["research-and-development", "process-development", "quality-control", "quality-and-regulatory"], status: "partial", currentLessonSlugs: ["analytical-procedure-lifecycle-q14", "analytical-method-validation", "analytical-method-transfer", "measurement-systems-analysis"], currentAssetIds: [], sourceIds: ["ICH-Q2-R2", "ICH-Q14", "ICH-Q9-R1"], decisionPackageIds: ["pharma-api-analytical-lifecycle", "drug-product-analytical-release-stability-packaging", "cross-cutting-evidence-governance"], materialGaps: ["No cross-modality analytical target profile and lifecycle working asset is featured."], requiredReviewerRoles: ["analytical development", "statistics", "quality control", "validation", "regulatory CMC"], nextAsset: "A modality-aware analytical target profile and lifecycle evidence map.",
      },
      {
        id: "statistics-data-and-process-understanding", title: "Statistics, data and process understanding", decision: "Choose analysis that matches the decision, measurement system, data structure and uncertainty.", functions: ["research-and-development", "process-development", "manufacturing-science", "quality-control"], status: "partial", currentLessonSlugs: ["statistical-process-control", "measurement-systems-analysis", "data-integrity-deep-dive", "decision-led-doe-and-multivariate-process-evidence"], currentAssetIds: [], sourceIds: ["ICH-Q9-R1", "FDA-DI-2018", "FDA-PROCESS-VALIDATION-2011"], decisionPackageIds: ["cross-cutting-evidence-governance"], materialGaps: ["Qualified review, real permissioned DoE or multivariate case, and model-governance evidence remain open."], requiredReviewerRoles: ["applied statistics", "process data science", "data integrity", "domain scientist"], nextAsset: "Qualified review and a real decision-led DoE or process-data case without generic model acceptance rules.",
      },
      {
