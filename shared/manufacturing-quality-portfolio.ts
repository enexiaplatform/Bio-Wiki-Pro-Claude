export const MANUFACTURING_QUALITY_PORTFOLIO_VERSION = "manufacturing-quality-portfolio/v1" as const;
...
export const MANUFACTURING_QUALITY_PORTFOLIO: ManufacturingQualityPortfolioLane[] = [
  {
    ...
    areas: [
      ...
      },
      {
        ...
        currentAssetIds: ["pharma-api-impurity-control"],
        sourceIds: ["ICH-Q3A-R2", "ICH-Q3C-R9", "ICH-Q3D-R2", "ICH-M7-R2", "ICH-Q6A", "ICH-Q11", "ICH-Q2-R2", "ICH-Q14", "ICH-Q9-R1"],
      ...
      },
      {
        ...
        materialGaps: ["Existing cross-cutting lessons are not yet assembled into an API-specific lifecycle package.", "No real API method, specification, stability, validation or site-transfer case is available."],
    ...
    areas: [
      {
        ...
        status: "not-covered",
        currentLessonSlugs: [], currentAssetIds: [], sourceIds: ["ICH-Q8-R2", "ICH-Q9-R1"],
        materialGaps: ["No dosage-form-specific formulation or material-attribute decision package exists."],
      ...
      },
      {
        ...
        functions: ["process-development", "manufacturing-science", "quality-control", "quality-and-regulatory"],
        status: "partial",
        currentLessonSlugs: ["process-validation-stages", "statistical-process-control", "equipment-qualification"], currentAssetIds: [],
        sourceIds: ["ICH-Q8-R2", "ICH-Q9-R1", "ICH-Q10", "FDA-PROCESS-VALIDATION-2011"],
        materialGaps: ["Generic validation and statistics lessons do not provide dosage-form-specific unit-operation or scale-up evidence."],
      ...
      },
      {
        ...
        status: "partial",
        currentLessonSlugs: ["dissolution-testing-usp-711", "stability-studies", "ongoing-stability-program", "container-closure-integrity", "extractables-and-leachables"], currentAssetIds: [],
        sourceIds: ["ICH-Q1A-R2", "ICH-Q2-R2", "ICH-Q6A", "ICH-Q14", "FDA-CONTAINER-CLOSURE-1999"],
        materialGaps: ["Existing lessons do not form one dosage-form-specific release, performance, stability and packaging package."],
      ...
      },
      {
        ...
        functions: ["process-development", "manufacturing-science", "quality-control", "quality-and-regulatory"],
        status: "partial",
        currentLessonSlugs: ["technology-transfer", "analytical-method-transfer", "process-validation-stages", "change-control"], currentAssetIds: [],
        sourceIds: ["WHO-TRS-1044-ANNEX4", "ICH-Q9-R1", "ICH-Q10", "FDA-PROCESS-VALIDATION-2011"],
        materialGaps: ["No integrated drug-product transfer or lifecycle working package is available."],
  ...
  },
  {
    ...
    areas: [
      ...
      },
      {
        ...
        sourceIds: ["ICH-Q5A-R2", "ICH-Q5C", "ICH-Q5E", "ICH-Q6B", "ICH-Q9-R1"], materialGaps: ["Qualified review and real permissioned downstream, analytical and formulation cases are absent."], requiredReviewerRoles: ["downstream process development", "product quality", "analytical development", "formulation development", "quality", "regulatory CMC"], nextAsset: "Qualified reviews and actual product/process outcome evidence.",
      },
      {
      ...
      },
      {
        ...
        functions: ["research-and-development", "process-development", "manufacturing-science", "quality-control", "quality-and-regulatory"], status: "not-covered", currentLessonSlugs: [], currentAssetIds: [], sourceIds: [], materialGaps: ["Cell and gene therapies, viral vectors, mRNA, vaccines, plasma products, ADCs and oligonucleotides require modality-specific scope and reviewers."], requiredReviewerRoles: ["modality-specific CMC", "manufacturing science", "analytical development", "quality", "regulatory CMC"], nextAsset: "Do not generalize the protein-biologics package; establish demand, sources, reviewers and validation cases first.",
      },
    ],
  },
  {
    ...
    areas: [
      {
        id: "analytical-development-and-lifecycle", title: "Analytical development and lifecycle", decision: "Define the analytical question, performance evidence, transfer and lifecycle controls before results support a decision.", functions: ["research-and-development", "process-development", "quality-control", "quality-and-regulatory"], status: "partial", currentLessonSlugs: ["analytical-procedure-lifecycle-q14", "analytical-method-validation", "analytical-method-transfer", "measurement-systems-analysis"], currentAssetIds: [], sourceIds: ["ICH-Q2-R2", "ICH-Q14", "ICH-Q9-R1"], materialGaps: ["No cross-modality analytical target profile and lifecycle working asset is featured."], requiredReviewerRoles: ["analytical development", "statistics", "quality control", "validation", "regulatory CMC"], nextAsset: "A modality-aware analytical target profile and lifecycle evidence map.",
      },
      {
        id: "statistics-data-and-process-understanding", title: "Statistics, data and process understanding", decision: "Choose analysis that matches the decision, measurement system, data structure and uncertainty.", functions: ["research-and-development", "process-development", "manufacturing-science", "quality-control"], status: "partial", currentLessonSlugs: ["statistical-process-control", "measurement-systems-analysis", "data-integrity-deep-dive", "decision-led-doe-and-multivariate-process-evidence"], currentAssetIds: [], sourceIds: ["ICH-Q9-R1", "FDA-DI-2018", "FDA-PROCESS-VALIDATION-2011"], materialGaps: ["Qualified review, real permissioned DoE or multivariate case, and model-governance evidence remain open."], requiredReviewerRoles: ["applied statistics", "process data science", "data integrity", "domain scientist"], nextAsset: "Qualified review and a real decision-led DoE or process-data case without generic model acceptance rules.",
      },
      {
        id: "quality-systems-investigations-and-change", title: "Quality systems, investigations and change", decision: "Move signals and changes through evidence, investigation, action, effectiveness and accountable decision pathways.", functions: ["manufacturing-science", "quality-control", "quality-and-regulatory"], status: "partial", currentLessonSlugs: ["oos-investigation-deep-dive", "deviation-management", "capa-fundamentals", "change-control", "pharmaceutical-quality-system-q10"], currentAssetIds: ["oos-investigation-template", "gmp-audit-kit"], sourceIds: ["FDA-OOS-2022", "ICH-Q9-R1", "ICH-Q10"], materialGaps: ["No permissioned end-to-end investigation-to-effectiveness case is available across API, drug product and Biopharma."], requiredReviewerRoles: ["quality control", "quality assurance", "manufacturing science", "data integrity", "regulatory CMC"], nextAsset: "Real cases that preserve corrections, disposition, change and effectiveness evidence.",
      },
    ],
  },
];
