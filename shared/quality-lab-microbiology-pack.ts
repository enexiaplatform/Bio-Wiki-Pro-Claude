...
export const MICROBIOLOGY_EVIDENCE_CATALOG: EvidenceRecord[] = [
  ...
  },
  {
    ...
    status: "public-reference",
    scope: "Context for pharmaceutical-water system, sampling, monitoring and microbial-control applications",
    limitations: "Atlas does not reproduce licensed text or infer water grade, sampling point, limit, trend, method or control strategy.",
  },
  {
    id: "usp-1116-context",
    ...
    locator: "https://online.uspnf.com/",
    status: "public-reference",
    scope: "Context for environmental-monitoring program and interpretation applications",
    limitations: "Atlas does not reproduce licensed text or set locations, methods, frequencies, limits, incubation strategy or actions.",
  },
  {
    id: "ph-eur-microbiology-context",
    canonicalSourceId: "PH-EUR-CURRENT",
    title: "European Pharmacopoeia current microbiological methods and monographs",
    kind: "regulatory-context",
    ...
    status: "public-reference",
    scope: "Licensed European Pharmacopoeia identity for applicable microbiology methods and water monographs",
    limitations: "Atlas stores source mapping, not licensed text; chapter, monograph, product and market applicability require qualified review.",
  },
  {
    id: "fda-nonsterile-draft-context",
    canonicalSourceId: "FDA-NONSTERILE-MICRO-2021",
    title: "Microbiological Quality Considerations in Non-Sterile Drug Manufacturing",
    kind: "regulatory-context",
    publisher: "U.S. Food and Drug Administration",
    version: "Draft Level 1 guidance",
    locator: "https://www.fda.gov/regulatory-information/search-fda-guidance-documents/microbiological-quality-considerations-non-sterile-drug-manufacturing",
    status: "public-reference",
    scope: "Draft guidance context for non-sterile drug microbiological quality and material/product risk questions",
    limitations: "Draft guidance is not for implementation and does not establish a binding requirement, method, material test or specification.",
  },
  {
...
export const MICROBIOLOGY_WORKFLOW_RULES: Record<MicrobiologyWorkflowKey, MicrobiologyWorkflowRule> = {
  rawMaterials: { id: "raw-material-micro", ruleId: "micro.workflow.raw-materials", label: "Raw-material microbiology", hours: 3.2, plateDays: 36, media: 0.32, tat: 5, criticality: "important", confidence: "indicative", evidenceIds: ["project-inputs", "atlas-microbiology-benchmarks-v1", "fda-nonsterile-draft-context", "site-approved-methods"], applicability: "Selected in-house raw-material microbiology with monthly incoming-lot demand", limitations: "One modeled unit per lot; actual specifications, skip-lot rules, preparation, replicates, and controls are unknown.", uncertaintyPercent: 35, rangeBasis: "Uncalibrated planning spread around the concept coefficient; replace with material-family time and occupancy evidence." },
  finishedProducts: { id: "finished-product-mlt", ruleId: "micro.workflow.finished-products", label: "Finished-product microbial limits", hours: 4.2, plateDays: 46, media: 0.45, tat: 5, criticality: "critical", confidence: "indicative", evidenceIds: ["project-inputs", "atlas-microbiology-benchmarks-v1", "usp-61-context", "usp-62-context", "site-approved-methods"], applicability: "Selected in-house non-sterile finished-product microbiology with monthly batch demand", limitations: "One modeled unit per batch; product families, sample count, method suitability, specified organisms, and registered specifications are unknown.", uncertaintyPercent: 25, rangeBasis: "Uncalibrated planning spread; product Method Graph nodes improve traceability but do not yet replace observed standard times." },
  water: { id: "water-microbiology", ruleId: "micro.workflow.water", label: "Pharmaceutical water microbiology", hours: 0.85, plateDays: 10, media: 0.12, tat: 5, criticality: "critical", confidence: "indicative", evidenceIds: ["project-inputs", "atlas-microbiology-benchmarks-v1", "usp-1231-context", "ph-eur-microbiology-context", "site-approved-methods"], applicability: "Selected in-house water testing using points × weekly rounds × 4.33", limitations: "Water grades, point criticality, sample volumes, method, alert/action levels, and investigation workload are unknown.", uncertaintyPercent: 35, rangeBasis: "Uncalibrated planning spread around a point-round coefficient; route, sample volume, filtration and excursion evidence can move the result materially." },
  environmentalMonitoring: { id: "environmental-monitoring", ruleId: "micro.workflow.environmental-monitoring", label: "Environmental monitoring", hours: 0.65, plateDays: 9, media: 0.08, tat: 5, criticality: "critical", confidence: "indicative", evidenceIds: ["project-inputs", "atlas-microbiology-benchmarks-v1", "eu-gmp-annex-1-2022", "usp-1116-context", "site-approved-methods"], applicability: "Selected in-house EM using locations × weekly rounds × 4.33", limitations: "Monitoring methods, grades, shifts, interventions, personnel counts, incubation strategy, reading, trending, and excursions are unknown.", uncertaintyPercent: 40, rangeBasis: "Uncalibrated planning spread around a location-round coefficient; method mix, route, activity and excursion demand remain open." },
  sterility: { id: "sterility-testing", ruleId: "micro.workflow.sterility", label: "Sterility testing", hours: 6, plateDays: 0, media: 0.5, tat: 14, criticality: "critical", confidence: "indicative", evidenceIds: ["project-inputs", "atlas-microbiology-benchmarks-v1", "eu-gmp-annex-1-2022", "site-approved-methods"], applicability: "Optional concept-only sterility scope with monthly batch demand", limitations: "Product presentations, method, batch grouping, isolator cycle, transfers, controls, and investigation burden are unknown; specialist review is mandatory.", uncertaintyPercent: 50, rangeBasis: "Wide uncalibrated specialist-gated planning spread; no sterility Method Graph node or site cycle evidence is present." },
  endotoxin: { id: "bacterial-endotoxin", ruleId: "micro.workflow.endotoxin", label: "Bacterial endotoxin testing", hours: 1.6, plateDays: 0, media: 0, tat: 1, criticality: "critical", confidence: "indicative", evidenceIds: ["project-inputs", "atlas-microbiology-benchmarks-v1", "site-approved-methods"], applicability: "Optional in-house endotoxin scope with explicit monthly sample demand", limitations: "Method, product limits, MVD, interference, replicates, standards, controls, and platform are unknown.", uncertaintyPercent: 35, rangeBasis: "Uncalibrated planning spread; method platform, dilution, interference and invalid-run evidence remain open." },
  bioburden: { id: "bioburden", ruleId: "micro.workflow.bioburden", label: "Bioburden testing", hours: 1.8, plateDays: 12, media: 0.16, tat: 5, criticality: "critical", confidence: "indicative", evidenceIds: ["project-inputs", "atlas-microbiology-benchmarks-v1", "site-approved-methods"], applicability: "Optional in-house bioburden scope with explicit monthly sample demand", limitations: "Matrices, sample preparation, filtration/plating, replicates, controls, limits, and method suitability are unknown.", uncertaintyPercent: 35, rangeBasis: "Uncalibrated planning spread; matrix, recovery, filtration and suitability evidence remain open." },
  growthPromotion: { id: "growth-promotion", ruleId: "micro.workflow.growth-promotion", label: "Growth-promotion testing", hours: 4, plateDays: 28, media: 1, tat: 5, criticality: "important", confidence: "indicative", evidenceIds: ["project-inputs", "atlas-microbiology-benchmarks-v1", "usp-61-context", "usp-62-context", "ph-eur-microbiology-context", "site-approved-methods"], applicability: "Selected in-house media QC with monthly media-lot demand", limitations: "Media types, container counts, organisms, negative controls, inoculum preparation, and supplier qualification strategy are unknown.", uncertaintyPercent: 40, rangeBasis: "Uncalibrated planning spread; media-organism-property matrix, container and reduced-testing evidence remain open." },
};
