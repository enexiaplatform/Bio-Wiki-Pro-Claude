...
This directory holds Architecture Decision Records. Each ADR captures one significant
decision: the context, the options considered, the decision, and its consequences.
...
| # | Title | Status |
|---|-------|--------|
| [0001](0001-content-mdx-postgres.md) | Content layer: MDX-in-repo + Postgres metadata hybrid | Accepted |
| [0002](0002-i18n-path-prefix-routing.md) | i18n via path-prefix routing | Proposed (not yet written) |
