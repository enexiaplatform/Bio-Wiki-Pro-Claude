...
These images are stored locally to keep the product fast and avoid third-party hotlinks. Each image was published as free to use under the Unsplash License. Attribution is displayed in the interface even though the license does not require it.

| Local file | Photographer | Source |
| --- | --- | --- |
| `pipette-laboratory.jpg` | Nathan Rimoux | https://unsplash.com/photos/AqVLU4cx8OI |
| `cleanroom-practice.jpg` | Toon Lambrechts | https://unsplash.com/photos/RkG7wp75b48 |
| `microscope-workbench.jpg` | Mezidi Zineb | https://unsplash.com/photos/dAHABqJ8Nlw |
