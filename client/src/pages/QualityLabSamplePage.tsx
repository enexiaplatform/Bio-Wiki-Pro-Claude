...
const samplePages = [
  ...
  "Action roadmap", "Calculation traceability", "Evidence and assumption registers", "Controlled handover",
];
    ...
    <div className="min-h-screen bg-[#07111f] px-4 pb-24 pt-8 text-slate-100 md:pt-14">
      <div className="mx-auto max-w-6xl">
        <header className="rounded-3xl border border-teal-300/20 bg-gradient-to-br from-teal-300/10 via-white/[0.035] to-transparent p-6 md:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-400 md:text-base">This 16-page synthetic example is generated by the same document engine used for paid Blueprint delivery. It includes the decision brief, quantitative charts, capability map, functional-space schematic, evidence controls and action roadmap.</p>
        ...
        <section className="mt-6 rounded-2xl border border-violet-300/15 bg-violet-300/[0.035] p-5 md:p-7">
          <div className="flex items-start gap-3"><Network className="mt-1 h-5 w-5 text-violet-300" /><div><p className="text-xs font-bold uppercase tracking-[0.16em] text-violet-300">Inside the 16-page public PDF</p><h2 className="mt-2 text-2xl font-bold">The same renderer, charts and control structure used for paid delivery.</h2></div></div>
