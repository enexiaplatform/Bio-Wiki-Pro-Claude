...
const samplePages = [
  "Cover and document control", "Executive decision brief", "Baseline vs future scenario", "Workload architecture",
  "Capability and method-control map", "Equipment capacity", "Workforce and skill coverage", "Functional space schematic",
  "CAPEX, OPEX and procurement gates", "Consumables and inventory exposure", "Decision controls", "Evidence readiness",
  "Decision sensitivity and evidence priority", "Action roadmap", "Calculation traceability", "Evidence and assumption registers", "Controlled handover",
];
      ...
      <div className="mx-auto max-w-6xl">
        <header className="rounded-3xl border border-teal-300/20 bg-gradient-to-br from-teal-300/10 via-white/[0.035] to-transparent p-6 md:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-teal-300">Under review · public illustrative sample</p>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-400 md:text-base">This 17-page synthetic example is generated by the same document engine used for paid Blueprint delivery. It includes the decision brief, quantitative charts, capability map, functional-space schematic, evidence controls, sensitivity analysis and action roadmap.</p>
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                ...
                <Link href="/quality-lab/review?offer=diagnostic" onClick={() => analytics.blueprintCtaClicked("public_sample", "diagnostic")} className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 px-5 py-3 text-sm font-semibold hover:border-white/30">Start with the $149 Diagnostic <ArrowRight className="h-4 w-4" /></Link>
              </div>
            </div>
            <div className="rounded-2xl border border-amber-300/20 bg-amber-300/[0.06] p-5 text-sm leading-6 text-amber-100/80"><ShieldCheck className="mb-3 h-5 w-5 text-amber-200" /><strong className="text-amber-100">Boundary:</strong> all figures below are illustrative inputs and concept calculations. This is not a customer result or an approved facility design. Engineering, validation, procurement and regulatory reliance require project-specific evidence and separately qualified professionals.</div>
          </div>
        </header>
        ...
        <section className="mt-6 rounded-2xl border border-violet-300/15 bg-violet-300/[0.035] p-5 md:p-7">
          <div className="flex items-start gap-3"><Network className="mt-1 h-5 w-5 text-violet-300" /><div><p className="text-xs font-bold uppercase tracking-[0.16em] text-violet-300">Inside the 17-page public PDF</p><h2 className="mt-2 text-2xl font-bold">The same renderer, charts and control structure used for paid delivery.</h2></div></div>
