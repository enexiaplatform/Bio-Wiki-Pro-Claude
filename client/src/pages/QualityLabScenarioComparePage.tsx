...
import {
  ...
  FlaskConical, Gauge, GitCompareArrows, Info, ShieldAlert, SlidersHorizontal,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-[#07111f] px-4 pb-24 pt-6 text-slate-100 md:pt-10">
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          ...
          {comparison && <button onClick={exportComparison} className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-bold text-slate-200 hover:border-teal-300/30 hover:text-white"><Download className="h-4 w-4" /> Export decision trace</button>}
        </div>
