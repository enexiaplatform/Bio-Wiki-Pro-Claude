...
export const workflowCategories: WorkflowCategory[] = [
  ...
  {
    slug: "pharma-api",
    title: "Pharma API Development & Quality",
    description: "Connect small-molecule drug-substance route and process development to impurity, analytical, control, validation and lifecycle evidence.",
    audience: "API process development, engineering/MSAT, analytical development, QC, quality and regulatory CMC",
    pathSlug: "pharma-api-development-quality",
    workflowSlugs: ["pharma-api-impurity-control"],
  },
  {
    slug: "biologics-qc",
    title: "Biopharma Product & Process Quality",
    description: "Connect cell substrate and manufacturing process to product quality, analytical control, stability, and lifecycle decisions.",
    audience: "Biopharma process development, MSAT, analytical development, manufacturing, QC, quality, and regulatory CMC",
    pathSlug: "biologics-biopharmaceutical-qc",
    workflowSlugs: ["biopharma-control-strategy", "cell-based-potency-assay", "host-cell-protein-testing-workflow", "viral-safety-testing-workflow"],
  },
  {
    slug: "drug-product",
    title: "Pharmaceutical Drug Product",
    description: "Connect formulation and material attributes to manufacturability, product performance, lifecycle evidence and accountable review.",
    audience: "Formulation, material science, process development, analytical development, quality and regulatory CMC",
    href: "/evidence/drug-product",
    workflowSlugs: ["drug-product-formulation-attribute-assessment"],
  },
  {
    slug: "career-skills",
    title: "Career Skills",
...
export const workflows: Workflow[] = [
  ...
  {
    slug: "drug-product-formulation-attribute-assessment",
    categorySlug: "drug-product",
    title: "Drug Product Formulation & Material Attribute Assessment",
    purpose: "Frame how formulation intent and API, excipient, process and presentation attributes connect to product performance and manufacturability evidence.",
    audience: "Formulation scientists, material scientists, process development, analytical development, quality and regulatory CMC reviewers.",
    useWhen: [
      "Framing a new or changed drug-product formulation",
      "Assessing API or excipient attribute variability",
      "Connecting formulation intent to unit operations and product performance",
      "Using an oral-solid-dose example without generalizing it to other dosage forms",
    ],
    inputs: [
      "Defined product, dosage-form boundary and intended performance question",
      "Known API and excipient attributes with evidence locators and versions",
      "Available formulation, process, analytical, stability and packaging evidence",
      "Named decision owner, reviewers, applicability and limitations",
    ],
    steps: [
      { title: "Freeze the decision and dosage-form boundary", detail: "Name the exact formulation or material-attribute decision, intended use and product/dosage-form scope before reviewing evidence." },
      { title: "Map formulation intent to performance", detail: "Record the intended function of each component and the product-performance questions it may influence without declaring causality." },
      { title: "Separate material evidence", detail: "Keep API, excipient, supplier, grade, lot, method and storage evidence distinct, including contradictions and reporting boundaries." },
      { title: "Connect process and presentation", detail: "Link relevant material/formulation questions to unit operations, scale, hold, analytical performance, stability, packaging and patient-use context." },
      { title: "Challenge the evidence chain", detail: "Identify missing comparability, measurement, biopharmaceutics, stability or manufacturing evidence and assign qualified reviewers." },
      { title: "Record the bounded next decision", detail: "Document what may proceed for further study, what remains evidence-required and which actions are not authorized." },
    ],
    criticalControlPoints: [
      "OSD examples remain synthetic and are not generalized to other dosage forms",
      "Material-function hypotheses are separated from demonstrated product impact",
      "No formula, level, design space, specification or bioequivalence conclusion is supplied",
      "Lifecycle changes reopen affected formulation, process, analytical, stability and filing questions",
    ],
    commonMistakes: [
      "Treating a supplier certificate as complete material suitability evidence",
      "Converting one development observation into a design-space or causality claim",
      "Ignoring process, packaging or stability interactions when a formulation input changes",
      "Using the OSD example as a recipe, precedent or dosage-form-wide rule",
    ],
    troubleshooting: [
      { problem: "A material attribute appears correlated with performance", action: "Preserve the observation, measurement method, batches and competing process/formulation explanations; define the evidence needed before a causal or control claim." },
      { problem: "Supplier or grade changes but the name is unchanged", action: "Compare the exact source, grade, functionality, characterization, process and stability evidence before an accountable change decision." },
      { problem: "The OSD example does not fit the product", action: "Stop using the example and retain only the general evidence questions; appoint dosage-form-specific reviewers before adding depth." },
    ],
    relatedLessonSlugs: ["drug-product-formulation-material-attributes", "quality-risk-management-q9", "stability-studies"],
    relatedToolkitSlugs: ["drug-product-formulation-material-attributes"],
    relatedToolSlugs: ["change-control-impact-triage", "stability-trend-shelf-life-planner"],
    accessTier: "pro",
    deepDive: "A formulation decision is a product-specific evidence chain, not a generic recipe. The chain connects intended performance to component function; API and excipient attributes to measurement and variability evidence; formulation choices to unit operations, stability, packaging and patient-use context; and each claim to applicability, limitations and accountable review. The synthetic OSD example shows how to structure questions only. It supplies no formulation, component level, operating range, design space, specification, bioequivalence result, validation conclusion or regulatory precedent.",
  },
  {
    slug: "pharma-api-impurity-control",
    categorySlug: "pharma-api",
    title: "Pharma API Process & Impurity Control Strategy",
    purpose: "Trace one small-molecule API route and process version from inputs and unit operations through impurity origin, observed fate, analytical capability, control placement and lifecycle change.",
    audience: "API process chemists, process engineers/MSAT, analytical development, impurity-safety specialists, QC, Quality Unit and regulatory CMC.",
    useWhen: [
      "Building or challenging an API process and impurity control strategy",
      "Assessing an actual or potential process-related impurity",
      "Reviewing an observed fate or purge claim",
      "Evaluating a supplier, route, solvent-recovery, isolation, scale, site or method change",
    ],
    inputs: [
      "Defined small-molecule drug substance, form, route and process version",
      "Controlled input, unit-operation, sampling and material-genealogy records",
      "Stage-specific analytical observations with method/version and reporting boundaries",
      "Applicable impurity-safety, specification, validation, filing and change-control context",
    ],
    steps: [
      { title: "Freeze the route and decision", detail: "Record the exact drug substance, form, route/process version, sites/scales, lifecycle stage, markets, decision and accountable owner." },
      { title: "Map inputs and unit operations", detail: "Connect each starting material, reagent, solvent, catalyst and recovered material to its exact use, quality risks, transformations, work-up, isolation and solid-state operations." },
      { title: "Map impurity origins", detail: "Keep predicted, observed and confirmed identity separate while recording plausible pathways, first relevant stage, competing hypotheses and applicable impurity class." },
      { title: "Test observed-fate evidence", detail: "Compare stage observations only when genealogy, sampling, units/basis, matrix and method capability support the comparison; label any ratio as observed and study-specific." },
      { title: "Challenge analytical capability", detail: "Verify intended use, matrix, reference/response basis, sensitivity, interference, preparation, lifecycle state and limitations before interpreting a non-detect or trend." },
      { title: "Place and stress-test controls", detail: "Compare input, process, in-process, intermediate and drug-substance controls, then document evidence, residual risk, variability and change triggers." },
      { title: "Route distinct decisions", detail: "Keep process understanding, impurity safety, analytical suitability, specification, validation, filing and batch disposition with their qualified owners." },
    ],
    criticalControlPoints: [
      "Evidence is tied to the exact route/process, stage, batch or experiment, sample and method version",
      "Non-detect and reporting-boundary statements do not imply zero material",
      "Observed ratios are not represented as transferable purge factors",
      "Different impurity classes retain their applicable evidence and specialist-review boundaries",
      "Changes reopen affected origin, fate, analytical, validation and filing questions",
    ],
    commonMistakes: [
      "Treating a final API chromatogram as the complete control strategy",
      "Calculating a purge factor from non-comparable samples, matrices, units or methods",
      "Calling a predicted structure a confirmed impurity identity",
      "Using a supplier certificate as the whole input-control rationale",
      "Converting an observed reduction into permission to remove a control",
    ],
    troubleshooting: [
      { problem: "The impurity is not detected after isolation", action: "Record the reporting boundary and challenge sampling, matrix, method capability, material balance, variability and process applicability before making a fate or control claim." },
      { problem: "Two stage results use different bases or preparation versions", action: "Mark the comparison evidence-required, preserve both observations, and define the analytical bridge needed before calculating or interpreting a ratio." },
      { problem: "A supplier or recovery-system change appears minor", action: "Map the exact changed source/configuration to impurity origin, process performance, analytical capability, validation, specification and filing questions before authorized implementation." },
    ],
    relatedLessonSlugs: ["pharma-api-starting-materials-input-control", "pharma-api-process-development-impurity-control", "pharma-api-analytical-specification-lifecycle", "nitrosamine-impurity-control", "residual-solvents-q3c", "elemental-impurities-q3d", "analytical-procedure-lifecycle-q14", "analytical-method-transfer", "process-validation-stages", "technology-transfer"],
    relatedToolkitSlugs: ["pharma-api-starting-material-input-control", "pharma-api-analytical-lifecycle", "pharma-api-impurity-control"],
    relatedToolSlugs: ["change-control-impact-triage"],
    accessTier: "pro",
    deepDive: "A defensible API control strategy is a route-specific network of evidence, not a final-test list. The useful chain links starting materials and process inputs to transformations and unit operations; actual and potential impurities to origin and pathway; stage observations to material genealogy, sampling and analytical capability; control placement to evidence, uncertainty and lifecycle resilience; and changes to validation, filing and authorized decisions. The workbook deliberately distinguishes a study-specific observed ratio from a purge factor and a reporting-boundary result from absence. It supplies no chemistry, process condition, acceptable intake, specification or approval.",
  },
  {
    slug: "biopharma-control-strategy",
    categorySlug: "biologics-qc",
    title: "Biopharma Product-Process Control Strategy",
    purpose: "Build a traceable evidence map from cell substrate and process conditions to product quality, analytical controls, stability, and lifecycle decisions.",
    audience: "Biopharma process development, MSAT, analytical development, manufacturing, QC, quality, and regulatory CMC teams.",
    useWhen: [
      "Building or reviewing a product and process control strategy",
      "Preparing for a site, scale, equipment, material, formulation, or method change",
      "Connecting development knowledge to release and stability controls",
      "Identifying which product-process claims still need evidence or specialist review",
    ],
    inputs: [
      "Defined product and modality scope",
      "Available product-quality, process-development, characterization, and stability knowledge",
      "Current manufacturing process and control strategy",
      "Proposed decision or change with accountable functional owners",
    ],
    steps: [
      { title: "Frame the product and decision", detail: "Record the modality, stage, intended product use, manufacturing scope, proposed decision, and accountable owner before mapping controls." },
      { title: "Map the product-quality attributes", detail: "List the attributes relevant to identity, activity, heterogeneity, impurities, safety, stability, and usability; distinguish evidence-backed criticality from a working hypothesis." },
      { title: "Map cell substrate and materials", detail: "Connect cell-bank and raw-material controls to the product and process risks they address, including open adventitious-agent and variability questions." },
      { title: "Trace upstream and downstream links", detail: "For each proposed material, parameter, unit-operation, impurity, product-variant, recovery, or viral-safety link, record mechanism, evidence, studied scope, uncertainty, and control." },
      { title: "Place each analytical control", detail: "Decide whether the attribute is addressed through characterization, in-process control, release, stability, process validation, or a justified combination." },
      { title: "Challenge lifecycle impact", detail: "For a change, compare pre-change and post-change evidence and record what remains unresolved for comparability, stability, filing, transfer, or quality-system review." },
      { title: "Close or escalate the evidence map", detail: "Assign each material gap to a qualified reviewer and preserve disagreement, assumptions, limitations, and the final accountable decision." },
    ],
    criticalControlPoints: [
      "The product and modality fall within the source and reviewer scope",
      "Every material control has a stated product or process rationale",
      "Platform knowledge is separated from product-specific evidence",
      "Passing release results are not treated as a complete comparability conclusion",
      "Qualified owners retain approval, filing, validation, and disposition authority",
    ],
    commonMistakes: [
      "Reducing the control strategy to a release-test list",
      "Calling a parameter or attribute critical without recording the evidence link",
      "Treating a platform process as automatic proof for a new molecule",
      "Ignoring formulation, shipping, stability, or container impacts after purification",
      "Applying protein-biologics guidance unchanged to an advanced modality",
    ],
    troubleshooting: [
      { problem: "A process parameter is labeled critical but the rationale is weak", action: "Record the proposed mechanism, supporting study or batch evidence, affected quality attribute, uncertainty, and reviewer needed to confirm or downgrade the claim." },
      { problem: "Release tests pass after a process change but a profile shifts", action: "Open a comparability question around the shifted attribute, method variability, process linkage, stability, and potential safety or efficacy relevance rather than relying on specification conformance alone." },
      { problem: "Functions disagree about whether evidence is sufficient", action: "Preserve the disagreement in the evidence map, name the decision owner, define the missing evidence that could resolve it, and avoid silently converting consensus pressure into a technical conclusion." },
    ],
    relatedLessonSlugs: ["biopharma-product-process-control-strategy", "biopharma-cell-line-cell-bank-genetic-stability", "biopharma-raw-ancillary-materials-control", "biopharma-upstream-process-control", "biopharma-downstream-purification-clearance", "biopharma-formulation-fill-finish-stability", "biopharma-integrated-analytical-control-strategy", "biopharma-process-validation-continued-verification", "biopharma-manufacturing-comparability", "biopharma-integrated-technology-transfer", "cell-bank-characterization", "protein-characterization", "cell-based-potency-assays", "viral-safety-testing"],
    relatedToolkitSlugs: ["biopharma-cell-substrate-control", "biopharma-materials-control", "biopharma-upstream-control", "biopharma-downstream-clearance", "biopharma-formulation-stability", "biopharma-analytical-control-strategy", "biopharma-process-validation-cpv", "biopharma-technology-transfer"],
    relatedToolSlugs: ["cell-based-potency-readiness-planner", "hcp-testing-readiness-planner", "viral-safety-readiness-planner"],
    accessTier: "pro",
    deepDive:
      "A biopharma control strategy is a network of claims and evidence: cell-substrate lineage, expression construct, clone rationale, bank lifecycle, characterization, genetic/phenotypic stability and production age influence process and product knowledge; raw/ancillary materials and the exact supplier/configured single-use system must be connected to intended use and lifecycle change; upstream and downstream conditions influence product-quality attributes; formulation and stability protect the complete presentation; the integrated analytical strategy connects attributes to complementary methods and reference systems; process validation and CPV connect process knowledge, qualified systems, representative execution, routine signals and controlled learning; and technology transfer tests receiving-unit capability. The useful artifact is not a generic list of hosts, tests, passage limits, approved suppliers, CQAs, CPPs, extractables claims, purification steps, assays, criteria, validation batches, statistical limits or transfer batches. It is a product-specific map that exposes the strength of each link, the evidence still missing, and the qualified owner of each distinct decision.",
  },
  {
    slug: "cell-based-potency-assay",
    categorySlug: "biologics-qc",
    title: "Cell-Based Potency Assay",
    purpose: "Run and control a cell-based bioassay that measures the biological activity of a biologic.",
    audience: "Biologics QC analysts running potency / bioassays.",
    useWhen: [
      "Releasing or stability-testing a biologic on potency",
      "Qualifying or validating a cell-based bioassay",
      "Investigating a failed or highly variable potency result",
      "Setting system suitability for a relative-potency assay",
    ],
    inputs: [
      "A validated, stability-indicating relative-potency method",
      "A qualified cell line with a controlled passage range",
      "A qualified reference standard and assay controls",
      "Defined system-suitability and parallelism criteria",
    ],
    steps: [
      { title: "Control the cell system", detail: "Use a qualified cell line within its validated passage range, and control seeding density and assay-readiness." },
      { title: "Design as relative potency", detail: "Run the sample against a qualified reference standard on the same plate and report relative potency, not absolute." },
      { title: "Run with controls", detail: "Include the reference standard, assay controls, and the required replicates and dilution series." },
      { title: "Check suitability and parallelism", detail: "Confirm system suitability and that the sample and reference curves are parallel before computing potency." },
      { title: "Compute relative potency", detail: "Calculate against the reference using the validated curve-fit model (e.g. a 4-parameter logistic)." },
      { title: "Investigate variability", detail: "High variability or non-parallelism triggers an investigation, not a quiet re-run." },
    ],
    criticalControlPoints: [
      "Cell line within its qualified passage range",
      "Relative potency against a qualified reference standard",
      "Parallelism (similarity) met before reporting potency",
      "System suitability and controls valid for each run",
    ],
    commonMistakes: [
      "Letting cell passage drift outside the qualified range",
      "Reporting potency from non-parallel curves",
      "Treating inherent bioassay variability as a failure without investigation",
      "Re-running until a pass without an assignable cause",
    ],
    troubleshooting: [
      { problem: "High assay variability run to run", action: "Examine cell passage and health, seeding density, plate edge effects, and incubation — control the biology before blaming the sample." },
      { problem: "Sample and reference curves are not parallel", action: "Non-parallelism can signal a different mechanism or a matrix issue — investigate before reporting; relative potency is only valid when curves are similar." },
      { problem: "The reference standard is nearing exhaustion", action: "Qualify a new reference standard by bridging against the current one before it runs out, to avoid a potency step-change." },
    ],
  ...
  {
    slug: "host-cell-protein-testing-workflow",
    categorySlug: "biologics-qc",
    title: "Host-Cell Protein Testing",
    purpose: "Measure and control host-cell protein impurities to demonstrate effective purification.",
    audience: "Biologics QC and analytical development controlling process-related impurities.",
    useWhen: [
      "Releasing drug substance on HCP impurity limits",
      "Qualifying an HCP ELISA (antibody coverage)",
      "Investigating a high or trending HCP result",
      "Demonstrating HCP clearance across the purification process",
    ],
    inputs: [
      "A qualified HCP method (typically a process-specific ELISA)",
      "An antigen-coverage assessment for the antibody reagent",
      "Reference HCP material and assay controls",
      "Acceptance limits justified by clearance and safety data",
    ],
    steps: [
      { title: "Choose the right HCP method", detail: "Use a process-specific ELISA where possible; orthogonal methods (e.g. mass spec) strengthen the coverage claim." },
      { title: "Establish antibody coverage", detail: "Assess what fraction of HCPs the antibody reagent detects — low coverage hides impurities." },
      { title: "Run with controls and dilutions", detail: "Include controls and a dilutional-linearity check to detect matrix interference." },
      { title: "Quantify against the standard", detail: "Report HCP (often ng/mg) against the reference, within the validated range." },
      { title: "Demonstrate process clearance", detail: "Show HCP reduction across the purification steps to support consistent control." },
      { title: "Investigate excursions", detail: "A high or trending HCP triggers an investigation of both the process and the method." },
    ],
    criticalControlPoints: [
      "Antibody / reagent coverage assessed and adequate",
      "Dilutional linearity confirmed (no matrix interference)",
      "Result within the validated range and against a qualified standard",
      "Limits justified by clearance and safety",
    ],
    commonMistakes: [
      "Trusting an ELISA without a coverage assessment",
      "Ignoring the hook effect / matrix interference at low dilution",
      "Reporting outside the validated range",
      "No orthogonal confirmation for a critical result",
    ],
    troubleshooting: [
      { problem: "HCP result is unexpectedly high", action: "Check for matrix interference and dilutional non-linearity first, then investigate the purification step, and confirm with an orthogonal method if critical." },
      { problem: "Suspected antibody-coverage gap", action: "Run an orthogonal coverage study (e.g. 2D gel or mass spec) — an ELISA can read 'clean' while missing HCPs it cannot detect." },
      { problem: "Non-linear dilution response", action: "This indicates matrix interference or a hook effect — establish the minimum required dilution and report within the linear range." },
    ],
  ...
  {
    slug: "viral-safety-testing-workflow",
    categorySlug: "biologics-qc",
    title: "Viral Safety Testing",
    purpose: "Assure viral safety of a biologic through source control, testing, and clearance.",
    audience: "Biologics QC, virology, and QA managing viral safety (ICH Q5A).",
    useWhen: [
      "Building the viral-safety strategy for a biologic (ICH Q5A)",
      "Testing cell banks and unprocessed bulk for viruses",
      "Validating viral clearance across purification",
      "Investigating an adventitious-agent signal",
    ],
    inputs: [
      "The ICH Q5A three-pillar strategy (source, testing, clearance)",
      "Qualified cell banks (MCB / WCB) with characterization data",
      "Validated viral assays (in vitro, in vivo as required, PCR-based)",
      "Viral-clearance spiking studies for the process",
    ],
    steps: [
      { title: "Control the source", detail: "Qualify and characterize the cell banks (MCB / WCB) and raw materials for adventitious agents." },
      { title: "Test at key stages", detail: "Test the cell banks and unprocessed bulk with the appropriate panel (e.g. in vitro assays and PCR for specific viruses)." },
      { title: "Validate viral clearance", detail: "Run spiking studies to quantify log-reduction across orthogonal purification steps (e.g. low-pH hold, nanofiltration, chromatography)." },
      { title: "Combine into a barrier approach", detail: "Show that testing plus clearance together provide an adequate margin against potential contamination." },
      { title: "Release on the strategy", detail: "Disposition relies on the integrated Q5A strategy, not on any single test." },
      { title: "Investigate any signal", detail: "An adventitious-agent signal triggers containment and a full investigation before release." },
    ],
    criticalControlPoints: [
      "Cell banks qualified and characterized for adventitious agents",
      "Orthogonal clearance steps with validated log-reduction",
      "Testing panel appropriate to the cell substrate and risk",
      "An integrated barrier (source + testing + clearance), not one test",
    ],
    commonMistakes: [
      "Relying on end-product testing alone (testing can't prove absence)",
      "Non-orthogonal clearance steps (correlated mechanisms overstate clearance)",
      "Inadequate cell-bank characterization",
      "Treating a contamination signal as a test artifact without containment",
    ],
    troubleshooting: [
      { problem: "Adventitious-agent signal in unprocessed bulk", action: "Contain immediately, halt processing of the affected material, investigate the source and the bank, and do not release pending a full assessment." },
      { problem: "Clearance steps share a mechanism", action: "Log-reductions are only additive when steps are orthogonal — re-justify the claim or add a mechanistically different step." },
      { problem: "A viral-assay control fails", action: "The run is invalid — confirm the assay controls and cell-substrate suitability, then repeat; never release on an invalid assay." },
    ],
