...
export const learningPaths: LearningPath[] = [
  ...
  {
    slug: "pharma-api-development-quality",
    title: "Pharma API Development & Quality",
    description: "Connect small-molecule drug-substance process development, impurity fate, analytical capability, control placement, validation and lifecycle evidence.",
    lessonSlugs: [
      ...
      "pharma-api-process-development-impurity-control",
      "pharma-api-isolation-solid-state-control",
      "pharma-api-analytical-specification-lifecycle",
      "pharma-api-process-validation-commercial-lifecycle",
    ],
  },
  {
  ...
  },
  {
    ...
    lessonSlugs: [
      "biopharma-full-lifecycle-product-process-orchestration",
      "biopharma-product-process-control-strategy",
      "biopharma-cell-line-cell-bank-genetic-stability",
      "biopharma-process-validation-continued-verification",
      "biopharma-raw-ancillary-materials-control",
      ...
      "biopharma-potency-reference-and-orthogonal-characterization",
      "biopharma-manufacturing-comparability",
