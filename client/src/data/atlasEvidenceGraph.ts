...
export const atlasEvidenceDomains: EvidenceDomain[] = [
  {
    ...
    resources: [
      ...
      resource("guide", "From equipment list to qualified QC utility demand", "/blog/from-equipment-list-to-qualified-qc-utility-demand", "Translate equipment operating states into point-of-use attributes, coincident demand, interfaces, monitoring, resilience and engineering handoff evidence.", ["workload-capacity", "equipment-utilities", "control-investigation", "lifecycle-governance"]),
      resource("guide", "From capability scope to a vendor-neutral URS and RFQ", "/blog/from-capability-scope-to-vendor-neutral-urs-rfq", "Compile intended use, method load and lifecycle needs into traceable requirements, comparable bids and controlled technical deviations.", ["scope-applicability", "method-architecture", "workload-capacity", "equipment-utilities", "lifecycle-governance"]),
      resource("guide", "When to insource or outsource QC testing", "/blog/when-to-insource-or-outsource-qc-testing", "Compare application-level capability, end-to-end turnaround, control, continuity and lifecycle cost before choosing an operating model.", ["scope-applicability", "method-architecture", "workload-capacity", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Quality laboratory startup, commissioning and operational readiness", "/blog/quality-lab-startup-commissioning-and-operational-readiness", "Reconcile facilities, utilities, equipment, methods, people, materials, data and continuity before a controlled scope goes live.", ["scope-applicability", "method-architecture", "workload-capacity", "equipment-utilities", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Phased QC laboratory procurement and expansion planning", "/blog/phased-qc-laboratory-procurement-and-expansion-planning", "Sequence capability waves through dependencies, long-lead decisions, critical paths, temporary capacity, cash flow and measured expansion triggers.", ["scope-applicability", "workload-capacity", "equipment-utilities", "lifecycle-governance"]),
      resource("guide", "Controlled Quality Lab Blueprint acceptance and handover", "/blog/controlled-quality-lab-blueprint-acceptance-and-handover", "Freeze scope, evidence and assumptions; disposition reviews; define acceptance meanings; and hand over owned actions without overstating approval.", ["scope-applicability", "method-architecture", "workload-capacity", "equipment-utilities", "control-investigation", "lifecycle-governance"]),
    ],
  },
  {
    ...
    resources: [
      ...
      resource("guide", "Microbial method suitability and recovery application pack", "/blog/method-suitability-to-microbiology-lab-capacity", "Connect product recovery evidence to preparation steps, BOM, qualification demand and operating capacity.", ["method-architecture", "workload-capacity", "control-investigation", "lifecycle-governance"]),
      ...
      resource("guide", "Microbiology incubator capacity and plate-day planning", "/blog/microbiology-incubator-capacity-and-plate-day-planning", "Convert method containers and duration into condition-specific position-days, qualified geometry, calendars, excursion exposure and backup demand.", ["method-architecture", "workload-capacity", "equipment-utilities", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Microbiology autoclave load and cycle capacity planning", "/blog/microbiology-autoclave-load-and-cycle-capacity-planning", "Translate media, reusable items and waste into load families, complete cycle occupancy, clean/dirty flow, utilities and downtime recovery.", ["method-architecture", "workload-capacity", "equipment-utilities", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Microbiology waste, decontamination and flow capability planning", "/blog/microbiology-waste-decontamination-and-flow-capability-planning", "Map method-derived waste streams through segregation, containment, hold, treatment, status release, capacity and continuity controls.", ["method-architecture", "workload-capacity", "equipment-utilities", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Microbiology sample receipt, hold and custody planning", "/blog/microbiology-sample-receipt-hold-and-custody-planning", "Connect sampling events to receipt acceptance, hold-time evidence, custody, storage, test-start queues and exception workload.", ["scope-applicability", "method-architecture", "workload-capacity", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Microbiology reference-culture lifecycle and capacity planning", "/blog/microbiology-reference-culture-lifecycle-and-capacity-planning", "Trace organism applications through source, genealogy, working stocks, inoculum verification, inventory, storage and continuity demand.", ["method-architecture", "workload-capacity", "equipment-utilities", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Microbiology investigation surge-capacity planning", "/blog/microbiology-investigation-surge-capacity-planning", "Model event-specific analyst, media, incubation, identification, review and backlog-recovery demand without authorizing extra testing.", ["method-architecture", "workload-capacity", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Microbiology analyst qualification and skill-coverage planning", "/blog/microbiology-analyst-qualification-and-skill-coverage-planning", "Map method tasks to current executor, reviewer and investigator authorization across shifts, absence, training and surge scenarios.", ["method-architecture", "workload-capacity", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Microbiology media and reagent readiness planning", "/blog/microbiology-media-reagent-readiness-and-inventory-planning", "Connect scheduled tests to lot release, status, expiry, storage, allocation, preparation and stockout decisions.", ["method-architecture", "workload-capacity", "equipment-utilities", "control-investigation", "lifecycle-governance"]),
      resource("guide", "Microbiology result review, data flow and release-capacity planning", "/blog/microbiology-result-review-data-flow-and-release-capacity-planning", "Trace raw observations, controls, calculations, exceptions and metadata through qualified review queues to authorized downstream decisions.", ["method-architecture", "workload-capacity", "control-investigation", "lifecycle-governance"]),
    ],
  },
  {
    id: "water-em",
